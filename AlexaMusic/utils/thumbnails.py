...
async def gen_thumb(videoid, user_id, theme):
    ...
    try:
        ...
        try:
            text_w, text_h = draw.textsize(f"♡••صلِّ على محمد••♡", font=font)
            draw.text(
                ((1280 - text_w) / 2, 30),
                f"مقدم من @ah_2_v",
                fill="red",
            ...
            text_w, text_h = draw.textsize(
                f"واتقوا يوما ترجعون فيه الى الله", font=arial
            )
            draw.text(
                ((1280 - text_w) / 2, 80),
                f"واتقوا يوما ترجعون فيه الى الله",
                fill="green",
                font=arial,
            )
            if para[0]:
            ...
            pass
        text_w, text_h = draw.textsize(f"قناة التلگرام @ah07v", font=arial)
        draw.text(
            ((1280 - text_w) / 2, 620),
            f"قناة التلگرام @ah07v",
            fill="white",
            font=arial,
        )
...
async def gen_qthumb(videoid, user_id, theme):
    ...
    try:
        ...
        try:
            ...
            text_w, text_h = draw.textsize(
                f"واتقوا يوما ترجعون في الى الله", font=arial
            )
            draw.text(
                ((1280 - text_w) / 2, 80),
                f"واتقوا يوما ترجعون فيه الى الله",
